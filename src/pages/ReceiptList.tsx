...
export const ReceiptList: React.FC<ReceiptListProps> = ({ filterType, onCreateNew, onEdit }) => {
  ...
  const handleSendTelegramReminder = async (r: Receipt) => {
    ...
    if (res.success) {
      alert(`✅ Telegram Reminder Sent to Group!\n\n- Customer Name : ${r.customer_name}\n- Car Model : ${r.vehicle_model}\n- Plate Number : ${r.plate_no}\n- Date : ${r.remind_date || r.created_date}\n- Phone Number : ${r.phone}`);
    } else {
            ...
            <div className="flex items-center justify-between bg-white p-4 rounded-2xl border border-slate-200/80 sticky top-0 z-10 shadow-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-xl bg-amber-500 px-4 py-2 text-xs font-extrabold text-slate-950 shadow-sm transition-all hover:bg-amber-600 active:scale-[0.98] cursor-pointer border border-amber-600"
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 whitespace-nowrap rounded-xl bg-[#E31B23] px-4 py-2 text-xs font-extrabold text-white shadow-sm transition-all hover:bg-[#C7151C] hover:shadow-red-600/20 active:scale-[0.98] cursor-pointer"
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 whitespace-nowrap rounded-xl bg-[#081525] px-4 py-2 text-xs font-extrabold text-white shadow-sm transition-all hover:bg-[#142742] active:scale-[0.98] cursor-pointer"
                  title="Print receipt"
                >
                  <Printer className="w-4 h-4" />
                  <span>Print</span>
